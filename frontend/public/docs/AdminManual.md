...
Журнал производственных карт по умолчанию отображается с установленным фильтром по состоянию карт в работе. При выборе состояния карт
в состоянии **Выполненные**, **С ошибкой**, **Отменённые** требуется указать период для получения списка. 
При выборе состояния появляеются дополнительные поля ввода фильтра: начало и окончание периода. Кнопкой **Обновить**
...
Прайс-листы находятся в меню Страницы - Прайс. В таблице прайсов отображаются действующие цены на продукцию. Данные цены
