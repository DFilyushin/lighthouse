...
export const MoneyToStr = (function () {
    MoneyToStr.NUM0 = 0;
    MoneyToStr.NUM1 = 1;
    MoneyToStr.NUM2 = 2;
    MoneyToStr.NUM3 = 3;
    ...
    function MoneyToStr(currency, language, pennies) {
        ...
        for (const index in items) {
            const languageItem = items[index];
        ...
        for (const index in currencyItem) {
